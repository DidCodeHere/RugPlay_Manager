    ...
    pub fn to_preset(&self) -> DipBuyerConfig {
        match self {
            Aggressiveness::Conservative => DipBuyerConfig {
                ...
                coin_tiers: vec![
                    CoinTier { label: "Micro".into(), min_mcap: 0.0, max_mcap: 25_000.0, buy_amount_usd: 100.0, min_sell_value_usd: 2_000.0, min_volume_24h: 5_000.0, max_buy_slippage_pct: 2.0 },
                    CoinTier { label: "Small".into(), min_mcap: 25_000.0, max_mcap: 100_000.0, buy_amount_usd: 250.0, min_sell_value_usd: 5_000.0, min_volume_24h: 10_000.0, max_buy_slippage_pct: 3.0 },
                    CoinTier { label: "Medium".into(), min_mcap: 100_000.0, max_mcap: 500_000.0, buy_amount_usd: 500.0, min_sell_value_usd: 8_000.0, min_volume_24h: 20_000.0, max_buy_slippage_pct: 0.0 },
                    CoinTier { label: "Large".into(), min_mcap: 500_000.0, max_mcap: 0.0, buy_amount_usd: 750.0, min_sell_value_usd: 10_000.0, min_volume_24h: 50_000.0, max_buy_slippage_pct: 0.0 },
                ],
                use_coin_tiers: false,
            ...
            Aggressiveness::Moderate => DipBuyerConfig {
                ...
                coin_tiers: vec![
                    CoinTier { label: "Micro".into(), min_mcap: 0.0, max_mcap: 25_000.0, buy_amount_usd: 200.0, min_sell_value_usd: 1_000.0, min_volume_24h: 3_000.0, max_buy_slippage_pct: 5.0 },
                    CoinTier { label: "Small".into(), min_mcap: 25_000.0, max_mcap: 100_000.0, buy_amount_usd: 500.0, min_sell_value_usd: 2_000.0, min_volume_24h: 5_000.0, max_buy_slippage_pct: 0.0 },
                    CoinTier { label: "Medium".into(), min_mcap: 100_000.0, max_mcap: 500_000.0, buy_amount_usd: 1000.0, min_sell_value_usd: 5_000.0, min_volume_24h: 10_000.0, max_buy_slippage_pct: 0.0 },
                    CoinTier { label: "Large".into(), min_mcap: 500_000.0, max_mcap: 0.0, buy_amount_usd: 1500.0, min_sell_value_usd: 10_000.0, min_volume_24h: 25_000.0, max_buy_slippage_pct: 0.0 },
                ],
                use_coin_tiers: false,
            ...
            Aggressiveness::Aggressive => DipBuyerConfig {
                ...
                coin_tiers: vec![
                    CoinTier { label: "Micro".into(), min_mcap: 0.0, max_mcap: 25_000.0, buy_amount_usd: 500.0, min_sell_value_usd: 500.0, min_volume_24h: 1_000.0, max_buy_slippage_pct: 10.0 },
                    CoinTier { label: "Small".into(), min_mcap: 25_000.0, max_mcap: 100_000.0, buy_amount_usd: 1000.0, min_sell_value_usd: 1_000.0, min_volume_24h: 2_000.0, max_buy_slippage_pct: 8.0 },
                    CoinTier { label: "Medium".into(), min_mcap: 100_000.0, max_mcap: 500_000.0, buy_amount_usd: 2000.0, min_sell_value_usd: 2_000.0, min_volume_24h: 5_000.0, max_buy_slippage_pct: 0.0 },
                    CoinTier { label: "Large".into(), min_mcap: 500_000.0, max_mcap: 0.0, buy_amount_usd: 3000.0, min_sell_value_usd: 5_000.0, min_volume_24h: 10_000.0, max_buy_slippage_pct: 0.0 },
                ],
                use_coin_tiers: false,
